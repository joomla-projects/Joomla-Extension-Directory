...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tickets&task=tickets.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_tickets&view=tickets'); ?>" method="post"
            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <table class="table table-striped" id="ticketList">
                    ...
                    <tr>
                        ...
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_TICKETS_TICKETS_ALLOCATED_TO_LABEL', 'a.`allocated_to`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_TICKETS_TICKETS_LINKED_ITEM_TYPE_LABEL', 'a.`linked_item_type`', $listDirn, $listOrder); ?>
                        </th>
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
                                <?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
                                    <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'tickets.', $canCheckin); ?>
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
