...
foreach ($displayData->varied as $st) {
    ...
    $fieldsets['links']['title']       = Text::_('COM_TICKETS_EXTENSION_LINKS_TITLE');
    ...
    $fieldsets['integration']['title']       = Text::_('COM_TICKETS_EXTENSION_INTEGRATION_TITLE');
    $fieldsets['integration']['description'] = Text::_('COM_TICKETS_EXTENSION_INTEGRATION_DESCR');
