...
<div class="span10 form-horizontal">
    ...
    <div class="row ticket-header-row">
        <div class="col-md-2   ticket-header">
            <h1><?php echo Text::_('COM_TICKETS_REVIEWS_FUNCTIONALITY_LABEL') . ' - ' . $linked_data[0]->functionality; ?></h1>
        </div>
    ...
    <div class="row ticket-header-row">
        <div class="col-md-2   ticket-header">
            <h1><?php echo Text::_('COM_TICKETS_REVIEWS_EASE_OF_USE_LABEL') . ' - ' . $linked_data[0]->ease_of_use; ?></h1>
        </div>
        <div class="col-md-10   ticket-header">
    ...
    <div class="row ticket-header-row">
        <div class="col-md-2   ticket-header">
            <h1><?php echo Text::_('COM_TICKETS_GENERAL_SUPPORT_LABEL') . ' - ' . $linked_data[0]->support; ?></h1>
        </div>
        <div class="col-md-10   ticket-header">
    ...
    <div class="row ticket-header-row">
        <div class="col-md-2   ticket-header">
            <h1><?php echo Text::_('COM_TICKETS_EXTENSION_DOCUMENTATION_LABEL') . ' - ' . $linked_data[0]->documentation; ?></h1>
        </div>
        <div class="col-md-10   ticket-header">
    ...
    <div class="row ticket-header-row">
        <div class="col-md-2   ticket-header">
            <h1><?php echo Text::_('COM_TICKETS_REVIEWS_VALUE_FOR_MONEY_LABEL') . ' - ' . $linked_data[0]->value_for_money; ?></h1>
        </div>
        <div class="col-md-10   ticket-header">
    ...
    <div class="row ticket-header-row">
        <div class="col-md-2   ticket-header">
            <h1><?php echo Text::_('COM_TICKETS_REVIEWS_OVERALL_SCORE_LABEL') . ' - ' . $linked_data[0]->overall_score; ?></h1>
        </div>
        <div class="col-md-10   ticket-header">
...
$fieldsets['scores']['title']       = Text::_('COM_TICKETS_REVIEW_SCORES_TITLE');
$fieldsets['scores']['description'] = Text::_('COM_TICKETS_REVIEW_SCORES_DESCR');
...
$fieldsets['comments']['title']       = Text::_('COM_TICKETS_REVIEW_COMMENTS_TITLE');
$fieldsets['comments']['description'] = Text::_('COM_TICKETS_REVIEW_COMMENTS_DESCR');
