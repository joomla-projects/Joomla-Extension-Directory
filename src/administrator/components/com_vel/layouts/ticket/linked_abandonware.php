...
$fieldsets['extensiondetails']['title']  = Text::_('COM_VEL_ABANDONEDREPORT_EXTENSION_TITLE');
            ...
            <div class="container">
                <div class="row">
                    ...
                    if ($rawData->get('vel_item_id') > 0) {
                        echo Text::_('COM_VEL_GENERAL_LABEL_NO_ACTIONS');
                    } else {
                        ?>
                        <button type="button" class="btn btn-primary"
                                onclick="Joomla.submitbutton('ticket.copyAbandonedReporttoVEL')">
                            <?php echo Text::_('COM_VEL_GENERAL_BUTTON_CREATE_ABANDONED_VEL'); ?>
                        </button>
                        <?php
                    } ?>
                </div>
