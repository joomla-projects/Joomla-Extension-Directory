 ...
 * @since 4.0.0
 */
class VulnerableitemModel extends AdminModel
{
    /**
     ...
     * @since 4.0.0
     */
    public $typeAlias = 'com_vel.vulnerableitem';
    /**
     ...
     * @throws Exception
     */
    public function getTable($name = 'Vulnerableitem', $prefix = 'Administrator', $options = []): Table
    {
    ...
    public function getVELLinkedReports(): array
    {
        ...
        $output['report']['data']  = $velReportData;
        $output['report']['model'] = $velReportModel;
        $output['report']['form']  = $velReportForm;
        ...
        $output['developerupdate']['data']  = $velDeveloperUpdateData;
        $output['developerupdate']['model'] = $velDeveloperUpdateModel;
        $output['developerupdate']['form']  = $velDeveloperUpdateForm;
    ...
    protected function loadFormData(): mixed
    {
        ...
        $data = Factory::getApplication()->getUserState('com_vel.edit.vulnerableitem.data', []);
