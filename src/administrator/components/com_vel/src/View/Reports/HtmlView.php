...
namespace Jed\Component\Vel\Administrator\View\Reports;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        $canDo       = JedHelper::getActions('com_vel', 'report');

        ToolbarHelper::title(Text::_('COM_VEL_TITLE_REPORTS'), "generic");
