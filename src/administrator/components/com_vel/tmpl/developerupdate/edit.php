...
/** @var \Jed\Component\Jed\Administrator\View\Veldeveloperupdate\HtmlView $this */
/**
 * @package VEL
 *
 * @subpackage VEL
...
<form
    ...
    <?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', ['active' => 'update']); ?>
    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'update', Text::_('COM_VEL_TAB_DEVELOPER_UPDATE', true)); ?>
    <div class="row-fluid">
    ...
    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'Publishing', Text::_('COM_VEL_GENERAL_PUBLISHING_LABEL', true)); ?>
    <div class="row-fluid">
        <div class="span10 form-horizontal">
            <fieldset class="adminform">
