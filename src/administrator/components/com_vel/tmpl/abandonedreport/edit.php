...
/** @var \Jed\Component\Jed\Administrator\View\Velabandonedreport\HtmlView $this */
/**
 * @package VEL
 *
 * @subpackage VEL
...
<form
    ...
    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'report', Text::_('COM_VEL_TAB_REPORT', true)); ?>
    <div class="row-fluid">
