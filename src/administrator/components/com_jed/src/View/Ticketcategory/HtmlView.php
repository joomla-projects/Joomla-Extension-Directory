...
use Jed\Component\Jed\Administrator\Model\TicketcategoryModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_JED_TITLE_TICKET_CATEGORY'), "generic");
