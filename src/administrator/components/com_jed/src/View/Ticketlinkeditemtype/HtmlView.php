...
use Jed\Component\Jed\Administrator\Model\TicketlinkeditemtypeModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_JED_TICKETS_LINKED_ITEM_TYPE_LABEL'), "generic");
    ...
    {
        /** @var TicketlinkeditemtypeModel $model */
        $model       = $this->getModel();
