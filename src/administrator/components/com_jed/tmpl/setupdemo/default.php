        ...
        <div class="col-md-12">
			...
			if ($this->task === "GO")
			{
				try
				{
					...
					$query = $db->getQuery(true)->select('extension_id')->from($db->quoteName('#__extensions'))->where('name = "com_jed"');
					$db->setQuery($query);
					...
					$menuitems[] = [
						...
						'params' => '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","robots":""}'
					];
					$menuitems[] = [
