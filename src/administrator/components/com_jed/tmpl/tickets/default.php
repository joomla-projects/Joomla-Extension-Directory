...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_jed&task=tickets.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_jed&view=tickets'); ?>" method="post"
