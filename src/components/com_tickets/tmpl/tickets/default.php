...
if (!$isLoggedIn) {
    ...
    $app->enqueueMessage(Text::_('COM_TICKETS_TICKETS_NO_ACCESS'), 'success');
    ...
    <form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post"
        ...
        <?php echo '<fieldset class="mytickets"><legend>' . Text::_('COM_TICKETS_TICKETS_LIST_HEADER') . '</legend>' . Text::_('COM_TICKETS_TICKETS_LIST_DESCR') . '</fieldset>'; ?>
