...
if (!$isLoggedIn) {
    ...
    $app->enqueueMessage(Text::_('COM_TICKETS_TICKET_NO_ACCESS'), 'success');
    ...
    <div class="ticket-edit front-end-edit">
        ...
        if (!$canEdit) : ?>
            <h3>
                <?php
                throw new Exception(Text::_('COM_TICKETS_GENERAL_ERROR_MESSAGE_NOT_AUTHORISED'), 403); ?>
            </h3>
        <?php else : ?>
            <form id="form-ticket"
                  action="<?php
                    echo Route::_('index.php?option=com_tickets&task=ticketform.save'); ?>"
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <a class="btn btn-danger"
                           href="<?php
                            echo Route::_('index.php?option=com_tickets&task=ticketform.cancel'); ?>"
                           title="<?php
                            echo Text::_('JCANCEL'); ?>">
