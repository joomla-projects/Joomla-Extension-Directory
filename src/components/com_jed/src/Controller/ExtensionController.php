    ...
    public function checkin()
    {
        ...
        if ($user->authorise('core.manage', 'com_jed') || $item->checked_out == Factory::getUser()->id) {
            ...
            if ($return === false) {
                ...
                $this->setRedirect(Route::_('index.php?option=com_jed&view=extension' . '&id=' . $id, false), $message, 'error');
                return false;
            } else {
                // Checkin succeeded.
                $message = Text::_('COM_JED_CHECKEDIN_SUCCESSFULLY');
                $this->setRedirect(Route::_('index.php?option=com_jed&view=extension' . '&id=' . $id, false), $message);
                return true;
            }
        } else {
    ...
    public function remove()
    {
        ...
        if ($user->authorise('core.delete', 'com_jed')) {
            ...
            if ($return === false) {
                ...
                $app->redirect(Route::_('index.php?option=com_jed&view=extensions', false));
            }
