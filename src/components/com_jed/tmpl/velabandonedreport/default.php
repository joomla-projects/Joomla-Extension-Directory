...
<div class="item_fields">
    ...
    <table class="table">
        ...
        <tr>
            <th><?php echo Text::_('COM_JED_VEL_ABANDONEDREPORTS_EXTENSION_NAME_LABEL'); ?></th>
        ...
        <tr>
            <th><?php echo Text::_('COM_JED_VEL_ABANDONEDREPORTS_EXTENSION_VERSION_LABEL'); ?></th>
            <td><?php echo $this->item->extension_version; ?></td>
        </tr>

        <tr>
            <th><?php echo Text::_('COM_JED_VEL_ABANDONEDREPORTS_EXTENSION_URL_LABEL'); ?></th>
