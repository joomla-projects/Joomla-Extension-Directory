...
if (!is_null($this->item)) {
    ...
    <div class="item_fields">
        ...
        <table class="table">
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_GENERAL_CONTACT_FULLNAME_LABEL'); ?></th>
                <td><?php echo $this->item->reporter_fullname; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_GENERAL_CONTACT_EMAIL_LABEL'); ?></th>
                <td><?php echo $this->item->reporter_email; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_GENERAL_REPORTER_ORGANISATION_LABEL'); ?></th>
                <td><?php echo $this->item->reporter_organisation; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_PASS_DETAILS_OK_LABEL'); ?></th>
                <td><?php echo $this->item->pass_details_ok; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_VULNERABILITY_TYPE_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_type; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_VULNERABLE_ITEM_NAME_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerable_item_name; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_VULNERABLE_ITEM_VERSION_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerable_item_version; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_EXPLOIT_TYPE_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_VULNERABILITY_ACTIVELY_EXPLOITED_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_actively_exploited; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_VULNERABILITY_PUBLICLY_AVAILABLE_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_publicly_available; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_VULNERABILITY_PUBLICLY_URL_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_DEVELOPER_COMMUNICATION_TYPE_LABEL'); ?></th>
                <td><?php echo $this->item->developer_communication_type; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_DEVELOPER_PATCH_DOWNLOAD_URL_LABEL'); ?></th>
                <td><?php echo $this->item->developer_patch_download_url; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_DEVELOPER_NAME_LABEL'); ?></th>
                <td><?php echo $this->item->developer_name; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_DEVELOPER_CONTACT_EMAIL_LABEL'); ?></th>
                <td><?php echo $this->item->developer_contact_email; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_TRACKING_DB_NAME_LABEL'); ?></th>
                <td><?php echo $this->item->tracking_db_name; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_TRACKING_DB_ID_LABEL'); ?></th>
                <td><?php echo $this->item->tracking_db_id; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_GENERAL_JED_URL_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_EXTENSION_DOWNLOAD_INTEGRATION_URL_LABEL'); ?></th>
                <td><?php echo $this->item->download_url; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_CONSENT_TO_PROCESS_NOTIFICATION_LABEL'); ?></th>
                <td><?php echo $this->item->consent_to_process; ?></td>
            </tr>
            <?php /*
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_PASSED_TO_VEL_LABEL'); ?></th>
                <td><?php echo $this->item->passed_to_vel; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_VEL_ITEM_ID_LABEL'); ?></th>
                <td><?php echo $this->item->vel_item_id; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_DATA_SOURCE_LABEL'); ?></th>
                <td><?php echo $this->item->data_source; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_GENERAL_DATE_SUBMITTED_LABEL'); ?></th>
                <td><?php echo $this->item->date_submitted; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_USER_IP_LABEL'); ?></th>
                <td><?php echo $this->item->user_ip; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_GENERAL_CREATED_BY_LABEL'); ?></th>
