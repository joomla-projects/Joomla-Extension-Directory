...
if (!is_null($this->item)) {
    ...
    <div class="item_fields">
        ...
        <table class="table">
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_CONTACT_ORGANISATION_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_VULNERABLE_ITEM_NAME_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_EXTENSION_UPDATE_LABEL'); ?></th>
                <td><?php echo $this->item->extension_update; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_NEW_VERSION_NUMBER_LABEL'); ?></th>
                <td><?php echo $this->item->new_version_number; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_UPDATE_NOTICE_URL_LABEL'); ?></th>
                <td><?php echo $this->item->update_notice_url; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_CHANGELOG_URL_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_GENERAL_FIELD_UPDATE_USER_IP_LABEL'); ?></th>
