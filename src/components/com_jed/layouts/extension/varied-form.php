...
?>
<p>Enter Unique information for each type of extension</p>
...
?>
        ...
        echo trim((string) $this->sublayout($sublayout, ['form' => $tmpl, 'basegroup' => $fieldname, 'group' => $fieldname . 'X', 'buttons' => $buttons]));
            ?></template>
        <?php endif; ?>
