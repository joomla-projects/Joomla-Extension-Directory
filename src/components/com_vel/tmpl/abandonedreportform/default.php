...
/** @var \Jed\Component\Vel\Site\View\abandonedreportform\HtmlView $this */
/**
 * @package VEL
 *
 * @subpackage VEL
    ...
    <div class="velabandonedreport-edit front-end-edit">
        ...
        <?php else : ?>
            <form id="form-velabandonedreport"
                  action="<?php echo Route::_('index.php?option=com_vel&task=abandonedreportform.save'); ?>"
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <a class="btn btn-danger"
                           href="<?php echo Route::_('index.php?option=com_vel&task=abandonedreportform.cancel'); ?>"
                ...
                <input type="hidden" name="task"
                       value="abandonedreportform.save"/>
