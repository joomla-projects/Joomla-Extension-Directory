...
/** @var \Jed\Component\Vel\Site\View\developerupdateform\HtmlView $this */
/**
 * @package VEL
 *
 * @subpackage VEL
    ...
    <div class="veldeveloperupdate-edit front-end-edit">
        ...
        <?php else : ?>
            <form id="form-veldeveloperupdate"
                  action="<?php echo Route::_('index.php?option=com_vel&task=developerupdateform.save'); ?>"
                ...
                $fieldsets['final']['fields'] = ['captcha'];
                $fscount                      = 0;
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <a class="btn btn-danger"
                           href="<?php echo Route::_('index.php?option=com_vel&task=developerupdateform.cancel'); ?>"
                ...
                <input type="hidden" name="task"
                       value="developerupdateform.save"/>
