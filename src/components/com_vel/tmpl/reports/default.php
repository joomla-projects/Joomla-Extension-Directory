...
/** @var \Jed\Component\Vel\Site\View\Reports\HtmlView $this */
...
if (!$isLoggedIn) {
    ...
    <form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post"
        ...
        <?php echo '<fieldset class="velreports"><legend>' . Text::_('COM_VEL_MYREPORTS_LIST_TITLE') . '</legend>' . Text::_('COM_VEL_MYREPORTS_LIST_DESCR') . '</fieldset>'; ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped" id="reportList">
                ...
                <tr>
                    ...
                    <th class=''>
                        <?php echo HTMLHelper::_('grid.sort', 'COM_VEL_GENERAL_EXPLOIT_TYPE_LABEL', 'a.exploit_type', $listDirn, $listOrder); ?>
                    </th>
                    <th class=''>
                ...
                <?php foreach ($this->items as $i => $item) : ?>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <a href="<?php echo Route::_('index.php?option=com_vel&view=reportform&id=' . (int) $item->id); ?>">
                                <?php echo $item->id; ?></a>
                        </td>
        ...
        <?php if ($canCreate) : ?>
            <a href="<?php echo Route::_('index.php?option=com_vel&task=reportform.edit&id=0', false, 0); ?>"
