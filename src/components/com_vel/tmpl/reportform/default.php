...
/** @var \Jed\Component\Vel\Site\View\Reportform\HtmlView $this */
/**
 * @package VEL
 *
 * @subpackage VEL
...
$wa->useScript('keepalive')
    ...
    ->useStyle('com_jed.form');
HTMLHelper::_('bootstrap.tooltip');

// Load admin language file
$lang = Factory::getApplication()->getLanguage();
$lang->load('com_vel', JPATH_SITE);
...
if (!$isLoggedIn) {
    try {
        ...
        $app->enqueueMessage(Text::_('COM_VEL_REPORTS_NO_ACCESS'), 'success');
    ...
    <div class="velreport-edit front-end-edit">
        ...
        <?php else : ?>
            <form id="form-velreport"
                  action="<?php echo Route::_('index.php?option=com_vel&task=reportform.save'); ?>"
                  method="post" class="form-validate form-horizontal" enctype="multipart/form-data">

            <?php

            $fieldsets['overview']['title']       = Text::_('COM_VEL_REPORTS_OVERVIEW_TITLE');
            $fieldsets['overview']['description']     = Text::_('COM_VEL_REPORTS_OVERVIEW_DESCR');
            ...
            $fieldsets['vulnerabilitydetails']['title']       = Text::_('COM_VEL_GENERAL_VULNERABILITY_DETAILS_TITLE');
            ...
            $fieldsets['developerdetails']['title']       = Text::_('COM_VEL_REPORTS_DEVELOPER_DETAILS_TITLE');
            $fieldsets['developerdetails']['description'] = Text::_('COM_VEL_REPORTS_DEVELOPER_DETAILS_DESCRIPTION');
            ...
            $fieldsets['moredeveloperdetails']['description'] = Text::_('COM_VEL_REPORTS_FORM_DEVELOPER_DETAILS_MORE_DESCR');
            ...
            $fieldsets['additionaldeveloperdetails']['title']       = Text::_('COM_VEL_REPORTS_DEVELOPER_DETAILS_ADDITIONAL_TITLE_LABEL');
            $fieldsets['additionaldeveloperdetails']['description'] = "";
            $fieldsets['additionaldeveloperdetails']['fields']      = [
            'developer_additional_info'];

            $fieldsets['filelocation']['title']       = Text::_('COM_VEL_REPORTS_FILELOCATION_TITLE');
            ...
            $fieldsets['final']['description'] = Text::_('COM_VEL_REPORTS_FORM_FINAL_DESCR');
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <a class="btn btn-danger"
                           href="<?php echo Route::_('index.php?option=com_vel&task=reportform.cancel'); ?>"
