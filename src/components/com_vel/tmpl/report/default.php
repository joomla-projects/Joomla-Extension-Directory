...
if (!is_null($this->item)) {
    ...
    <div class="item_fields">
        ...
        <table class="table">
            ...
            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_PASS_DETAILS_OK_LABEL'); ?></th>
                <td><?php echo $this->item->pass_details_ok; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_VULNERABILITY_TYPE_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_type; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_REPORTS_VULNERABLE_ITEM_NAME_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_EXPLOIT_TYPE_LABEL'); ?></th>
                <td><?php echo $this->item->exploit_type; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_EXPLOIT_OTHER_DESCRIPTION_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->exploit_other_description); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_VULNERABILITY_DESCRIPTION_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->vulnerability_description); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_VULNERABILITY_HOW_FOUND_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->vulnerability_how_found); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_VULNERABILITY_ACTIVELY_EXPLOITED_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_actively_exploited; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_VULNERABILITY_PUBLICLY_AVAILABLE_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_publicly_available; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_REPORTS_VULNERABILITY_PUBLICLY_URL_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_publicly_url; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_VULNERABILITY_SPECIFIC_IMPACT_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->vulnerability_specific_impact); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_DEVELOPER_COMMUNICATION_TYPE_LABEL'); ?></th>
                <td><?php echo $this->item->developer_communication_type; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_DEVELOPER_PATCH_DOWNLOAD_URL_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_DEVELOPER_CONTACT_EMAIL_LABEL'); ?></th>
                <td><?php echo $this->item->developer_contact_email; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_TRACKING_DB_NAME_LABEL'); ?></th>
                <td><?php echo $this->item->tracking_db_name; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_TRACKING_DB_ID_LABEL'); ?></th>
                <td><?php echo $this->item->tracking_db_id; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_JED_URL_LABEL'); ?></th>
                <td><?php echo $this->item->jed_url; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_DEVELOPER_ADDITIONAL_INFO_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_VEL_GENERAL_CREATED_BY_LABEL'); ?></th>
    ...
    <div class="jed-error">
        <?php echo Text::sprintf('COM_VEL_REDIRECT_TO_MY_LISTS', Text::_('COM_VEL_REDIRECT_VELREPORT')); ?>
        <br/>
        <a href="index.php?option=com_vel&view=reports" class="btn btn-primary"><?php echo Text::_('JYES'); ?></a>
    </div>
    <?php
}
?>
