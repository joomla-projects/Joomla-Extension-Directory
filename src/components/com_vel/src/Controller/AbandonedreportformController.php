 ...
 * @since 4.0.0
 */
class AbandonedreportformController extends FormController
{
    /**
    ...
    public function cancel($key = null): void
    {
        ...
        // Get the model.
        $model = $this->getModel('Abandonedreportform', 'Site');
    ...
    public function save($key = null, $urlVar = null): void
    {
        ...
        if ($data === false) {
            ...
            $this->setRedirect(Route::_('index.php?option=com_vel&view=abandonedreportform&layout=edit&id=' . $id, false));
