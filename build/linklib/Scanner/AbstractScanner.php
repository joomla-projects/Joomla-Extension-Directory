...
abstract class AbstractScanner implements ScannerInterface
{
     ...
     * @return  string
     */
    final public function getExtensionRoot(): string
    {
     ...
     * @return  string
     */
    final public function getLanguageRoot(): string
    {
     ...
     * @return  string
     */
    final public function getSiteRoot(): string
    {
     ...
     * @return  void
     */
    final public function setSiteRoot(string $path)
    {
        $path = realpath($path);
     ...
     * @return  ScanResult
     */
    final public function getScanResults(): ScanResult
    {
     ...
     * @return  MapResult
     */
    final public function getLinkMap(): MapResult
    {
     ...
     * @return  array
     */
    final protected function scanLanguageNode(\DOMElement $node)
    {
     ...
     */
    final protected function scanLanguageFolder(string $langPath): array
    {
        $ret = [];
