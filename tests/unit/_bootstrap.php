...
{
	define('JPATH_COMPONENT_SITE', dirname(dirname(JPATH_BASE)) . '/src/component/com_jed');
}

if (!defined('JPATH_COMPONENT_ADMINISTRATOR'))
{
	define('JPATH_COMPONENT_ADMINISTRATOR', dirname(dirname(JPATH_BASE)) . '/src/administrator/component/com_jed');
}
