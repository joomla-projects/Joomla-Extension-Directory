...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Review Report Received', 'Review Report Received',
        ...
        1, 652, 652, '2021-05-13 14:37:13', '2021-05-13 14:37:13', 1);
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Listing Submission Received', 'Listing Submission Received',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Listing Update Received', 'Listing Update Received',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension Report Received', 'Extension Report Received',
        '<p>Your report has been successfully received and a ticket has been opened. A team member will look into the issue and you should receive an update to your ticket within the next 3 business days.</p>',
        1, 652, 652, '2021-05-13 14:38:15', '2021-05-13 14:38:15', 1);

insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension - JED Checker Errors', 'Extension - JED Checker Errors',
        ...
        2, 652, 652, '2021-05-13 14:40:36', '2021-05-13 14:40:36', 1);
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: ER1 - error_reporting(0) Found', 'Extension: ER1 - error_reporting(0) Found',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: NM1 - Install Name Doesn\'t Match Listing Name',
        'Extension: NM1 - Install Name Doesn\'t Match Listing Name',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: LK2 - Invalid Download Link', 'Extension: LK2 - Invalid Download Link',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: ZP1 - Zipfile Issues', 'Extension: ZP1 - Zipfile Issues',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: NM2 - Extension Specific Naming Issue', 'Extension: NM2 - Extension Specific Naming Issue',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: TM2 - Use of the Joomla Trademark', 'Extension: TM2 - Use of the Joomla Trademark',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension - Hidden Files or Folders', 'Extension - Hidden Files or Folders',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: NM3 - Non-Permitted Words in Name', 'Extension: NM3 - Non-Permitted Words in Name',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension - Plugin Install Name', 'Extension - Plugin Install Name',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension - Backlink Issues', 'Extension - Backlink Issues',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: LC2 - Paid Listing without License Link', 'Extension: LC2 - Paid Listing without License Link',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension - Listed on VEL', 'Extension - Listed on VEL',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension - Broken Links', 'Extension - Broken Links',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Ticket - Misdirected Support Request', 'Ticket - Misdirected Support Request',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Ticket - Not Enough Detail', 'Ticket - Not Enough Detail',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: LC1 - Licensing Violation', 'Extension: LC1 - Licensing Violation',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: LC3 - License Link does not Mention Extensions',
        'Extension: LC3 - License Link does not Mention Extensions',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: LC4 - Invalid License Type', 'Extension: LC4 - Invalid License Type',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: US1 - Update Server Requirement', 'Extension: US1 - Update Server Requirement',
...
insert into `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`, `modified_by`,
                                       `created`, `modified`, `state`)
values (0, 'Extension: PE1 - Under Investigation', 'Extension: PE1 - Under Investigation',
        ...
        2, 652, 652, '2021-05-13 14:40:36', '2021-05-13 14:40:36', 1);
INSERT INTO `#__jed_message_templates`(`id`, `title`, `subject`, `template`, `email_type`, `created_by`,
                                       `modified_by`, `created`, `modified`, `state`)
VALUES (1000, 'System Messages: Thank you for contacting ', 'Confirmation of Submission',
        ...
        1, 652, 652, '2021-05-13 14:40:36', '2021-05-13 14:40:36', 1);
...
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (1, 'Unknown', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (2, 'Extension', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (3, 'Review', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (4, 'Joomla Site Issue', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (5, 'New Listing Support', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (6, 'Current Listing Support', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (7, 'Site Technical Issues', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (8, 'Unpublished Support', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (9, 'Reported Review', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (10, 'Reported Extension', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (11, 'Vulnerable Item Report', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (12, 'VEL Developer Update', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_categories`(`id`, `categorytype`, `ordering`, `state`, `checked_out`, `checked_out_time`,
                                       `created_by`, `modified_by`)
values (13, 'VEL Abandonware Report', 0, 1, NULL, NULL, 652, 652);
...
insert into `#__jed_ticket_groups`(`id`, `name`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`,
                                   `modified_by`)
values (1, 'Any', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_groups`(`id`, `name`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`,
                                   `modified_by`)
values (2, 'Team Leadership', 0, 1, 0, '0000-00-00 00:00:00', 652, 652);
insert into `#__jed_ticket_groups`(`id`, `name`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`,
                                   `modified_by`)
values (3, 'Listing Specialist', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_groups`(`id`, `name`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`,
                                   `modified_by`)
values (4, 'Review Specialist', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_groups`(`id`, `name`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`,
                                   `modified_by`)
values (5, 'Support Speciailist', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_groups`(`id`, `name`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`,
                                   `modified_by`)
values (6, 'VEL Specialist', 0, 1, NULL, NULL, 652, 652);
...
insert into `#__jed_ticket_linked_item_types`(`id`, `title`, `model`, `ordering`, `state`, `checked_out`,
                                              `checked_out_time`, `created_by`, `modified_by`)
values (1, 'Unknown', 'unknown', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_linked_item_types`(`id`, `title`, `model`, `ordering`, `state`, `checked_out`,
                                              `checked_out_time`, `created_by`, `modified_by`)
values (2, 'Extension', 'Extension', 1, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_linked_item_types`(`id`, `title`, `model`, `ordering`, `state`, `checked_out`,
                                              `checked_out_time`, `created_by`, `modified_by`)
values (3, 'Review', 'Review', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_linked_item_types`(`id`, `title`, `model`, `ordering`, `state`, `checked_out`,
                                              `checked_out_time`, `created_by`, `modified_by`)
values (4, 'Vulnerable Item Initial Report', 'Velreport', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_linked_item_types`(`id`, `title`, `model`, `ordering`, `state`, `checked_out`,
                                              `checked_out_time`, `created_by`, `modified_by`)
values (5, 'Vulnerable Item Developer Update', 'Veldeveloperupdate', 0, 1, NULL, NULL, 652, 652);
insert into `#__jed_ticket_linked_item_types`(`id`, `title`, `model`, `ordering`, `state`, `checked_out`,
                                              `checked_out_time`, `created_by`, `modified_by`)
values (6, 'VEL Abandonware Report', 'Velabandonedreport', 0, 1, NULL, NULL, 652, 652);
...
insert into `#__jed_extension_supply_options`(`id`, `title`, `state`, `ordering`, `checked_out`, `checked_out_time`,
                                              `created_by`, `modified_by`)
values (1, 'Free', 1, 1, NULL, NULL, 627, 627);
insert into `#__jed_extension_supply_options`(`id`, `title`, `state`, `ordering`, `checked_out`, `checked_out_time`,
                                              `created_by`, `modified_by`)
values (2, 'Paid', 1, 2, NULL, NULL, 627, 627);
insert into `#__jed_extension_supply_options`(`id`, `title`, `state`, `ordering`, `checked_out`, `checked_out_time`,
                                              `created_by`, `modified_by`)
values (3, 'Cloud', 1, 3, NULL, NULL, 627, 627);
...
(
    ...
    `title`                   varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `alias`                   varchar(400) CHARACTER SET utf8 COLLATE utf8_bin              DEFAULT NULL,
    `body`                    mediumtext COLLATE utf8mb4_unicode_ci,
    `functionality`           int                                                           DEFAULT '0',
    `functionality_comment`   text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    ...
    `used_for`                varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `version`                 varchar(255) COLLATE utf8mb4_unicode_ci                       DEFAULT NULL,
    `flagged`                 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
    `ip_address`              varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `published`               varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
    `created_on`              datetime                                                      DEFAULT NULL,
    `created_by`              int                                                           DEFAULT '0',
    `ordering`                int                                                           DEFAULT '0',
    `checked_out`             int unsigned                                                  DEFAULT NULL,
...
(
    ...
    `gpl_license_type`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `jed_internal_note`     text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    `can_update`            tinyint(1)                                                    DEFAULT '0',
    `video`                 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `version`               varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `uses_updater`          tinyint(1)                                                    DEFAULT '0',
    `includes`              varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `approved`              tinyint(1)                                                    DEFAULT '0',
    `approved_time`         datetime                                                      DEFAULT NULL,
    `second_contact_email`  varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    ...
    `approved_reason`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `published_notes`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `published_reason`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
...
(
    ...
    `download_link`             varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `demo_link`                 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `support_link`              varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `documentation_link`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `license_link`              varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `translation_link`          varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `tags`                      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `update_url`                varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `update_url_ok`             tinyint(1)                                                    DEFAULT '0',
    `download_integration_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
    `download_integration_url`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
...
(
    ...
    `developer_name` varchar(150) CHARACTER SET latin1 DEFAULT NULL,
