...
<form
        ...
        method="post" enctype="multipart/form-data" name="adminForm" id="ticketinternalnote-form"
        class="form-validate form-horizontal">


	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'ticketinternalnote')); ?>
