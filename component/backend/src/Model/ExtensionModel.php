...
class ExtensionModel extends AdminModel
{
	 ...
	 * @throws Exception
	 */
	public function getForm($data = array(), $loadData = true, $formname = 'jform_extension'): Form
	{
		// Get the form.
		$form = $this->loadForm('com_jed.extension', 'extension', array('control' => $formname, 'load_data' => $loadData));
	 ...
	 * @throws Exception
	 */
	public function getTable($name = 'Extension', $prefix = 'Administrator', $options = array()): Table
	{
...
//291505
	 ...
	 * @throws Exception
	 */
	public function getVariedDataForm($data = array(), $loadData = true, $formname = 'jform_extensionvarieddata'): Form
	{
		// Get the form.
		$form = $this->loadForm('com_jed.extensionvarieddatum', 'extensionvarieddatum', array('control' => $formname, 'load_data' => $loadData));
