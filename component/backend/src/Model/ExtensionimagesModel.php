...
class ExtensionimagesModel extends ListModel
{
	...
	public function __construct($config = array())
	{
		...
		{
			$config['filter_fields'] = array('id', 'a.id', 'state', 'a.state', 'ordering', 'a.ordering', 'created_by', 'a.created_by', 'modified_by', 'a.modified_by', 'extension_id', 'a.extension_id', 'filename', 'a.filename',);
		}
