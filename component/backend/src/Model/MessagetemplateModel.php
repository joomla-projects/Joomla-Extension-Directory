...
class MessagetemplateModel extends AdminModel
{
	...
	public function getForm($data = array(), $loadData = true,$formname = 'jform'): Form
	{
		// Get the form.
		$form = $this->loadForm(
			'com_jed.messagetemplate', 'messagetemplate',
	 ...
	 * @throws Exception
	 */
	public function getTable($name = 'Messagetemplate', $prefix = 'Administrator', $options = array()): Table
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_jed.edit.messagetemplate.data', array());
