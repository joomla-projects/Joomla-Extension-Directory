...
class TicketinternalnoteModel extends AdminModel
{
	...
	public function getForm($data = array(), $loadData = true,$formname = 'jform'): Form
	{
		// Get the form.
		$form = $this->loadForm(
			'com_jed.ticketinternalnote', 'ticketinternalnote',
	 ...
	 * @throws Exception
	 */
	public function getTable($name = 'Ticketinternalnote', $prefix = 'Administrator', $options = array()): Table
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_jed.edit.ticketinternalnote.data', array());
