...
class ExtensionscoreModel extends AdminModel
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jed.extensionscore', 'extensionscore', array('control' => 'jform', 'load_data' => $loadData));
	 ...
	 *
	 */
	public function getTable($name = 'Extensionscore', $prefix = 'Administrator', $options = array()): Table
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_jed.edit.extensionscore.data', array());
