 ...
 */
		...
		document.querySelectorAll("rating-selector").forEach(function(index) {
			const widget = this;
			...
			ratingSelectors[index] = raterJs( {
				...
				rateCallback:function rateCallback(rating, done) {
					...
					el.closest('.control-group').classList.remove("error");
					done();
				},
			...
			widget.find('.clear-rating').addEventListener('click', (e) => {
				e.preventDefault();
