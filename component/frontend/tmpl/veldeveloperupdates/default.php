...
$canCreate   = $user->authorise('core.create', 'com_jed') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'veldeveloperupdateform.xml');
$canEdit     = $user->authorise('core.edit', 'com_jed') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'veldeveloperupdateform.xml');
