...
$app=null;
	...
	static public function CreateReviewTicket(int $item_id): array
	{
...
//       <option value="7">Vulnerable Item Email Correspondence</option> */
	 ...
	 * @since 4.0.0
	 */
	static public function CreateEmptyTicketMessage(): array
	{
		$user                               = JedHelper::getUser();
	 ...
	 * @since   4.0.0
	 */
	static public function formatImage(string $filename, ImageSize $size = ImageSize::SMALL): string
	{
		if (!$filename)
		{
			return '';
