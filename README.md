...
Now moved to Joomla 6 development - Installation on Joomla 4 will FAIL.
...
--
Install as an Extension into a clean Joomla 6 installation. Do not create any users other than the admin.
